  ...
  render() {
    return (
      <div>
        ...
        <div className={ styles.Rows }>
          <button onClick={ this.props.getValue } value="7" className={ styles.BtnStyle }>7</button>
          <button onClick={ this.props.getValue } value="8" className={ styles.BtnStyle }>8</button>
          <button onClick={ this.props.getValue } value="9" className={ styles.BtnStyle }>9</button>
          <button onClick={ this.props.getValue } value="+" className={ styles.BtnStyle + ' ' + styles.Operation }>+</button>
        </div>

        <div className={ styles.Rows }>
          <button onClick={ this.props.getValue } value="4" className={ styles.BtnStyle }>4</button>
          <button onClick={ this.props.getValue } value="5" className={ styles.BtnStyle }>5</button>
          <button onClick={ this.props.getValue } value="6" className={ styles.BtnStyle }>6</button>
          <button onClick={ this.props.getValue } value="-" className={ styles.BtnStyle + ' ' + styles.Operation }>-</button>
        </div>

        <div className={ styles.Rows }>
          <button onClick={ this.props.getValue } value="1" className={ styles.BtnStyle }>1</button>
          <button onClick={ this.props.getValue } value="2" className={ styles.BtnStyle }>2</button>
          <button onClick={ this.props.getValue } value="3" className={ styles.BtnStyle }>3</button>
          <button onClick={ this.props.getValue } value="*" className={ styles.BtnStyle + ' ' + styles.Operation }>*</button>
        </div>
